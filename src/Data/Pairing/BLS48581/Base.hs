...
-- | @Fq24 = Fq8[z]/<z^3 + w>@.
data PolynomialZ
instance IrreducibleMonic PolynomialZ G2.Fq8 where
  poly _ = X3 + Y X
  {-# INLINE poly #-}
type Fq24 = Extension PolynomialZ G2.Fq8

-- | @Fq48 = Fq24[s]/<s^2 + z>@.
data PolynomialS
instance IrreducibleMonic PolynomialS Fq24 where
  poly _ = X2 + Y X
  {-# INLINE poly #-}
type Fq48 = Extension PolynomialS Fq24
